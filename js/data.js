const courses = [
  {
    ...
    price: 'Rs. 1,299', old: 'Rs. 3,999', badge: 'pop',
    icon: 'DESIGN', bg: 'linear-gradient(135deg,#1e3a5f,#0f2a45)',
  ...
  },
  {
    ...
    price: 'Rs. 1,999', old: 'Rs. 5,999', badge: '',
    icon: 'DEV', bg: 'linear-gradient(135deg,#3d1a4a,#1a0a2e)',
  ...
  },
  {
    ...
    price: 'Rs. 0', old: '', badge: 'free',
    icon: 'DATA', bg: 'linear-gradient(135deg,#1a3a2a,#0a2a1a)',
  ...
  },
  {
    ...
    price: 'Rs. 2,499', old: 'Rs. 6,999', badge: 'new',
    icon: 'AI', bg: 'linear-gradient(135deg,#4a2a1a,#2a1a0a)',
  ...
  },
  {
    ...
    price: 'Rs. 999', old: 'Rs. 2,999', badge: '',
    icon: 'BIZ', bg: 'linear-gradient(135deg,#3a3a1a,#2a2a0a)',
  ...
  },
  {
    ...
    price: 'Rs. 1,499', old: 'Rs. 4,499', badge: '',
    icon: 'MOTION', bg: 'linear-gradient(135deg,#2a1a3a,#1a0a2a)',
  ...
  },
  {
    ...
    price: 'Rs. 1,799', old: 'Rs. 4,999', badge: 'new',
    icon: 'LLM', bg: 'linear-gradient(135deg,#1a2a3a,#0a1a2a)',
  ...
  },
  {
    ...
    price: 'Rs. 0', old: '', badge: 'free',
    icon: 'IOS', bg: 'linear-gradient(135deg,#3a1a1a,#2a0a0a)',
  ...
  },
  {
    ...
    price: 'Rs. 899', old: 'Rs. 2,499', badge: '',
    icon: 'SQL', bg: 'linear-gradient(135deg,#1a2a1a,#0a1a0a)',
  ...
  },
  {
    ...
    price: 'Rs. 1,199', old: 'Rs. 3,499', badge: 'pop',
    icon: 'MARKETING', bg: 'linear-gradient(135deg,#2a1a0a,#1a0a00)',
